import type { DocumentedInput, FinancialSnapshot, FinancialSnapshotInput, NormalizedFinancialInputs, PurchaseCandidate, PurchaseCandidateInput } from "./domain/entities";
...
export interface DecisionEngine {
    readonly calculateAvailableToSpend: (snapshot: FinancialSnapshot) => AvailableToSpendResult;
    readonly buildTimeline: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => TimelineResult;
    readonly simulateScenario: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => ScenarioSimulation;
    readonly assessRisk: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => RiskAssessment;
    readonly assessGoalImpact: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => GoalImpactResult;
    readonly assessConfidence: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => ConfidenceAssessment;
    readonly recommend: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => RecommendationResult;
    readonly explain: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => ExplanationResult;
    readonly future: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => FutureResult;
    readonly evaluatePurchase: (snapshot: FinancialSnapshot, purchase: PurchaseCandidate) => PurchaseEvaluation;
    readonly forecast: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => ForecastResult;
    readonly confidence: (snapshot: FinancialSnapshot, purchase?: PurchaseCandidate) => DecisionConfidence;
}
export type { Currency, FinancialSnapshot, FinancialSnapshotInput, ModelVersion, Money, NormalizedFinancialInputs, PurchaseCandidate, PurchaseCandidateInput };
